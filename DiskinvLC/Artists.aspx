...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <!-- The start of list view -->
    <h1 style="font-family: monospace; color: #006699">Artists<asp:ListView ID="ListView1" runat="server" DataKeyNames="artist_id" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem">
